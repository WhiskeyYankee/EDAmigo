...
# Pass in:  
  ...
  # missing_user_level of 1, indicating that the user prefers to interact with the handleMissing() function

result <- autoClean(df, special_user_level = 0, factor_tol = 10, type_user_tol = 10, missing_user_level = 0)
```
